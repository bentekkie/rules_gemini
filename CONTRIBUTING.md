...
This is mostly a joke for now. I dont expect to be accepting any contributions
...
some other ruleset that depends on rules_gemini, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_gemini=$(pwd)/rules_gemini"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_gemini` on your system will point to this folder.
...
https://github.com/myorg/rules_gemini/actions/workflows/tag.yaml
